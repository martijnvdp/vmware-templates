...
publish-template -Template_file $template_path"\win2019.core.json" -Template_var_file $template_var_path"\win2019.core.variables.json" -template_edition "core" -template_unattended $template_path"\autounattend.xml" -template_path_packer "c:\packer" -credential $credential -winadmin_password $localadmin_password
publish-template -Template_file $template_path"\win2019.standard.json" -Template_var_file $template_var_path"\win2019.standard.variables.json" -template_edition "standard" -template_unattended $template_path"\autounattend.xml" -template_path_packer "c:\packer" -credential $credential -winadmin_password $localadmin_password
