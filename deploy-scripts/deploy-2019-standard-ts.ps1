...
#####
$deploy_params = @{
    template_file        = $PSscriptroot + "/../templates/Windows/2019/STANDARD/Standard-rdp-host.json"
    template_var_file    = $PSscriptroot + "/../templates/Windows/2019/STANDARD/Standard-rdp-host.variables.json"
